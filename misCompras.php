...
$lista_compras = $compra->obtenerCoompras($Id);
?>
<html>
    <head>
        <title>Happy PetStore | Mis compras</title>
        <!-- for-mobile-apps -->
    ...
    <body>
        ...
        <div class="mail animated wow zoomIn" data-wow-delay=".5s">
            <div class="container">
                <h3>Mis compras</h3>
                <p class="est">Muestra los datos de tus compras realizadas con tu cuenta de Happy PetShop.</p>
                <div class="mail-grids">
                    <div class="col-md-12 mail-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                        <div id="misTarjetas">
                            <?php if ($lista_compras["valido"] == "false") { ?>
                                <p>No tienes compras registradas</p>
                            <?php } else { ?>
                                <h4 style="color: #cc3300">Tu lista de compras realizadas</h4>
                                <br>
