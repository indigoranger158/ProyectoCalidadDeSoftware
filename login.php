<?php
/* Revisa si hay una sesion iniciada para evitar que se inicie otra */
session_start();
...
<html>
    <head>
        <title>Happy PetStore | Inicio de sesión</title>
        <!-- for-mobile-apps -->
    ...
    <body>
        ...
        <div class="breadcrumbs">
            <div class="container">
                <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                    ...
                    <li class="active">Pagina de inicio de sesión</li>
                </ol>
            </div>
        </div>
        <!-- //breadcrumbs -->
        ...
        <div class="login">
            <div class="container">
                <h3 class="animated wow zoomIn" data-wow-delay=".5s">Inicia sesión</h3>
                <p class="est animated wow zoomIn" data-wow-delay=".5s">Completa el formulario de inicio de sesión para ingresar a tu cuenta personal de Happy PetShop y seguir comprando en nuestra tienda.</p>
                <div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
                    <form id="frmInicio">
                        <input type="email" placeholder="Correo electrónico..." required=" " name="Email"><small id="small_alerta_inicioEmail" style="opacity: 0">*Campo vacio o formato erroneo</small>
                        <input type="password" placeholder="Contraseña..." required=" " name="Contrasena"><small id="small_alerta_inicioContrasena" style="opacity: 0">*Campo vacio</small>
                        <div class="forgot">
                            <a href="#">¿Olvidaste tu contraseña?</a>
                        </div>
                        <input type="button" id="btnInicio" value="Inicia">
                        <small id="small_alerta_inicio" style="opacity: 0">*Algunos datos son erroneos o estan vacios</small>
                    </form>
                </div>
                <h4 class="animated wow slideInUp" data-wow-delay=".5s">¿Eres nuevo en Happy PetShop?</h4>
