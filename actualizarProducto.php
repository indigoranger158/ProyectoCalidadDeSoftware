...
<html>
    <head>
        <title>Happy PetStore | Actualizar producto</title>
        <!-- for-mobile-apps -->
            ...
            <div class="container">
                <div class="typo-grids">
                    <div class="page-header animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
                        <center>
                        <h3 class="bars">Actualizar descuentos de productos</h3>
                        <form id="frmActualizarDescuentoProducto">
                            <div id="actualizarDescuento">
                                <p style="color: #ff6633">Actualize el descuento del producto</p> 
                                <strong style="font-size: 20px;">Buscar producto por id para actualizar su descuento:</strong>
                                <input type="number" name="Id" id="idProductoAActualizarDescuento">
                                <input type="button" id="btnBuscarProductoAActualizarDescuento" value="Buscar producto">
                                <center><img src="images/13836785d0bbdd53727c4fd5c107cb64.png" id="imagenProducto" width="150px"></center> 
                                <br>
                                <strong style="font-size: 20px;">Nombre de la marca:</strong>
                                <input type="text" id="nombreProducto" disabled="disable" value="">
                                <strong style="font-size: 20px;">Descuento:</strong>
                                <input type="text" id="descuentoProducto" disabled="disable" value="">
                                <strong style="font-size: 20px;">Precio:</strong>
                                <input type="text" id="precioProducto" disabled="disable" value="">
                                <center>
                                <strong style="font-size: 20px;">Nuevo precio:</strong>
                                <br>
                                <input type="number" name="nuevoPrecioProducto" id="nuevoPrecioProducto" disabled="disable" value="">
                                <br>
                                <strong style="font-size: 20px;">Nuevo descuento:</strong>
                                <br>
                                <input type="number" name="nuevoDescuentoProducto" id="nuevoDescuentoProducto" disabled="disable" value=""> 
                                </center>
                                <p id="totalNuevoDescuento"></p>
                                <input type="button" id="aceptarActualizarDescuento" style="background: grey;" disabled="disable" value="Aceptar">
                                <input type="button" id="cancelarActualizarDescuento" style="background: grey;" disabled="disable" value="Cancelar">
                            </div>
                        </form> 
                        </center>
                    </div>
