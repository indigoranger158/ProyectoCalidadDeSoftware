...
<html>
    <head>
        <title>Happy PetStore | Eliminar usuario</title>
        <!-- for-mobile-apps -->
        ...
        <div class="typo">
            <div class="container">
                <div class="typo-grids">
                    <center>
                        <h3 class="animated wow zoomIn" data-wow-delay=".5s" style="font-size: 35">Eliminar un usuario de la base de la datos</h3> 
                    </center>
                    <br>
                    <center>
                    <p class="est animated wow zoomIn" data-wow-delay=".5s" style="text-align: center">Ingresa el Id de un usuario almacenado en la base de datos para eliminarlo junto con las imagenes y comentarios asociados al mismo.</p>
                    <br>
                    <img src="images/borrar usuario-icon.jpg" width="100px">
                    </center>
                    <center>
                    <div class="page-header animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
                        <h3 class="bars">Eliminar un usuario</h3>
                        <form id="frmEliminarUsuario">
                            <p>Digite el id del usuario que desea eliminar</p>
                            <input type="number" name="Id" id="IdUsuarioAEliminar">
                            <input type="button" value="Eliminar" id="btnUsuarioAEliminar">
                            <br>
                            <div id="divConfirmacionEliminarUsuario">
                                <input type="hidden" name="imagenPerfilUsuario" id="imagenPerfilUsuario" value="">
                                <img src="images/usuarios/user-iconpredeterminado.jpg" id="imagenUsuarioAEliminar">
                                <p id="nombreUsuarioAEliminar" style="color: #cc3300;"></p>
                                <p id="emailUsuarioAEliminar" style="color: #cc3300;"></p>
                                <strong style="font-size: 1em;">Deseas realmente eliminar el usuario con el id introducido</strong>
                                <br>
                                <br>
                                <label for="btnAceptarEliminarUsuario"><img src="images/check-icon.png"></label>
                                <label for="btnCancelarEliminarUsuario"><img src="images/cancel-icon.png"></label>
                                <input type="button" id="btnAceptarEliminarUsuario" hidden="">
                                <input type="button" id="btnCancelarEliminarUsuario" hidden="">
                                <br>
                                <small>Revisa la lista de usuarios si no estas seguro.</small>
                            </div>
                        </form>
                    </div>
                    </center>
                    <div class="page-header animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
                        <h3 class="bars">Lista de usuarios registrados</h3>
                    </div>  
                    <div class="bs-docs-example animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms" style="height: 400px;overflow: auto;">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php foreach ($lista_usuarios["datos-usuarios"] as $user) { ?>
                                    <tr>
                                        <td><?php echo $user["Id"]; ?></td>
                                        <td><img src="<?php echo $user["Dir_Imagen_Perfil"]; ?>" width="60px"></td>
                            ...
                            <h4>Total de usuarios: <?php echo $lista_usuarios["cant-usuarios"]; ?></h4>
                        </table>
                    </div>
                </div>
            </div>
